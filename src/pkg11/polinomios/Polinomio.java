...
public class Polinomio {
    ...
    public boolean esCero() {
        return cabeza == null || (cabeza.coeficiente == 0 && cabeza.siguiente == null);
    }
    ...
    public static ResultadoDivision dividir(Polinomio p1, Polinomio p2) {
        Polinomio cociente = new Polinomio();
        Polinomio dividendo = p1; //copia del dividendo
        ...
        while (apuntador1 != null && apuntador2 != null && esDivisible(apuntador1, apuntador2)) {
            ...
            apuntador1 = residuo.getMayorExponente();
            //apuntador2 sigue exactamente igual
        }
        return new ResultadoDivision(cociente, residuo);
    }
